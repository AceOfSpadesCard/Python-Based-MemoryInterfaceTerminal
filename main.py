...
# Defining the red color function
def red_color(string):
    print('\033[31m' + string, '\033[39m')

# Defining the blue color function
def blue_color(string):
    print(cr.Fore.BLUE + string + color_end)
...
while not exit_code:
    ...
    # Reading from an external .txt. storage file
        ...
        try:
            ...
            blue_color(str(total))
            file_handle.close()
        except:
            red_color("[error{1} file does not exist]")
    ...
    # Error 2 Command does not exist
        ...
        red_color("[error{2} command does not exist]")
